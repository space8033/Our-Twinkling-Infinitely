	...
	<body class="container">
		...
		<!------------------------------------- 내용 들어갈 div -------------------------------------->
				...
				<div class="d-flex justify-content-center">
					<input id="submit" class="inputHolder" type="submit" style="border: none; margin-bottom: 5px; background-color: #0073e8; color: white;" value="저장">
				</div>
				<div class="d-flex justify-content-center">
					<input id="cancel" type="submit" class="inputHolder" style="border: 1px solid #d8d8d8; margin-top: 5px; background-color: white; color: #b44442;" value="삭제">
				</div>
			</form>
		</div>
	</body>
