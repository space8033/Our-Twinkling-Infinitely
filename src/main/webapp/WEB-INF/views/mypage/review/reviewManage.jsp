...
<html>
   <head>
      ...
      <script src="reviewManage.js"></script>
   ...
   <body>
                  ...
                  <div id="myCoupangLMT">
                     ...
                     <div>
                        ...
                        <ul class="listLeft"> 
                           ...
                           <li><a href="reviewManage.jsp" style="color: rgb(95, 144, 210)">리뷰관리</a></li>
                           <li><a href="#">찜리스트</a></li>
                        </ul>
                     </div>
                     <hr>
      ...
      <!------------------------------------- 내용 들어갈 div -------------------------------------->
            	<div class="pl-3 pt-3" style="width: 100%;">
            		<div class="d-flex" style= "width: 100%;">
            			<div style="font-size: 28px; font-weight: bold;">리뷰관리</div>
            			<div style="font-size: 14px; padding-top: 20px; padding-left: 10px; color: #5e73ac; cursor: pointer;">
            				리뷰 운영원칙
            			</div>
            		</div>
            		
            		<div class= "d-flex p-3" style="width: 95%; margin-top: 15px; border: 2px solid #efefef; border-top: 2px solid #efefef">
            			<div>
            				<img src="//img1a.coupangcdn.com/image/coupang/review/web/mycoupang/pc-profile-empty.png" name="프로필 이미지">
            			</div>
            			<div class="px-4" style="border-right: 2px solid #efefef; font-size: 30px;">오우주</div>
            			<div>
            				<div class="px-4">도움</div>
            				<div style="font-size: 20px;">0명</div>
            			</div>
            			<div>
            				<div>랭킹</div>
            				<div>11,236,999 등(1점)</div>
            			</div>
            		</div>
