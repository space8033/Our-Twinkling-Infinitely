			...
			<form onsubmit="return false;">
				...
				<div>
					...
					<table class="receiverInfo">
						<tr>
							<th>이름</th>
							<td>김시온 <span id="border1">기본 배송지</span> <span id="border2"
								>로켓프레시 가능</span> <span id="border3">로켓와우
									가능</span>
							</td>
						</tr>
						<tr>
					...
					<table class="payInfomation">
						...
						<tr>
							...
							<td  style="margin:0px; padding:0px;">
								<div style=" padding-top:10px; padding-left:16px; color: red; padding-bottom:10px;"><span style= "width:155px; display:inline-block;">-<span id="discount" ">0</span>원</span>
