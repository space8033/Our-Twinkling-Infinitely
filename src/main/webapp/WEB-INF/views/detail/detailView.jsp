				...
				<div class="tab-content">
		      	...
		      	<tbody>
				      ...
				      <div class="d-flex justify-content-center m-4">
						...
						<c:if test="${pager8.groupNo>1}">
							<a class="btn btn-sm" href="?product_no=${product.product_no}&pageNo=${pager8.startPageNo-1}">이전</a>
						</c:if>
						
						<c:forEach var="i" begin="${pager8.startPageNo}" end="${pager8.endPageNo}">
							<c:if test="${pager8.pageNo != i}">
						...
						<c:if test="${pager8.groupNo<pager8.totalGroupNo}">
							<a class="btn btn-sm" href="?product_no=${product.product_no}&pageNo=${pager8.endPageNo+1}">다음</a>
						</c:if>
						<a class="btn btn-sm" href="?product_no=${product.product_no}&pageNo=${pager8.totalPageNo}">맨끝</a>
					  </div>
